...
std::string yuvi420_to_nv12_rotate_r90_opencl_code() { return R_CODE( // ########################## begin of OpenCL C code ####################################################################
    ...
    kernel void
    kYuvI420ToNV12RotateRight90(__global const unsigned char* in_buff_yuv,  // 0, m_input_buff_yuv
        ...
        int uv_start = y_bytes_size + (ru_pos.y * u_block_height) * y_height + ru_pos.x * u_block_height * 2;  // r-width = y_height
...
std::string yuvi420_to_nv12_rotate_l90_opencl_code() { return R_CODE( // ########################## begin of OpenCL C code ####################################################################
    // Only required by version 1.0.0 of the extension, version 2.0.0 does not
    // require the following pragma.
    // #pragma OPENCL EXTENSION cl_arm_printf : enable
    ...
    kernel void
    kYuvI420ToNV12RotateLeft90(__global const unsigned char* in_buff_yuv,  // 0, m_input_buff_yuv
                               __global unsigned char* out_buff_yuv,             // 1, m_output_buff_yuv
                               const int y_width,                                // 2, y_width
                               const int y_height,                               // 3, y_height
                               const int y_bytes_size,                           // 4, y_width * y_height
        ...
        // rotated - y image block
        uchar8 rl0 = (uchar8)(yl0.s7, yl1.s7, yl2.s7, yl3.s7, yl4.s7, yl5.s7, yl6.s7, yl7.s7);
        uchar8 rl1 = (uchar8)(yl0.s6, yl1.s6, yl2.s6, yl3.s6, yl4.s6, yl5.s6, yl6.s6, yl7.s6);
        uchar8 rl2 = (uchar8)(yl0.s5, yl1.s5, yl2.s5, yl3.s5, yl4.s5, yl5.s5, yl6.s5, yl7.s5);
        uchar8 rl3 = (uchar8)(yl0.s4, yl1.s4, yl2.s4, yl3.s4, yl4.s4, yl5.s4, yl6.s4, yl7.s4);
        uchar8 rl4 = (uchar8)(yl0.s3, yl1.s3, yl2.s3, yl3.s3, yl4.s3, yl5.s3, yl6.s3, yl7.s3);
        uchar8 rl5 = (uchar8)(yl0.s2, yl1.s2, yl2.s2, yl3.s2, yl4.s2, yl5.s2, yl6.s2, yl7.s2);
        uchar8 rl6 = (uchar8)(yl0.s1, yl1.s1, yl2.s1, yl3.s1, yl4.s1, yl5.s1, yl6.s1, yl7.s1);
        uchar8 rl7 = (uchar8)(yl0.s0, yl1.s0, yl2.s0, yl3.s0, yl4.s0, yl5.s0, yl6.s0, yl7.s0);
        // rotated u-block index
        // rotated u block height equal to u-block-width, rotated y width equal to y-height.
        int2 ru_pos = (int2)(uy, max_u_x_index - ux);
        int rlu_start = (ru_pos.y * u_block_width * 2) * y_height + (ru_pos.x * u_block_height * 2);
        ulong8 r_offsets = indexs8 * y_height;
        r_offsets += (rlu_start + (ulong)out_buff_yuv);
        // write rotated y image data
        ...
        // uv lines
        uchar8 uvl0 = (uchar8)(ul0.s3, vl0.s3,   ul1.s3, vl1.s3,   ul2.s3, vl2.s3,   ul3.s3, vl3.s3);
        uchar8 uvl1 = (uchar8)(ul0.s2, vl0.s2,   ul1.s2, vl1.s2,   ul2.s2, vl2.s2,   ul3.s2, vl3.s2);
        uchar8 uvl2 = (uchar8)(ul0.s1, vl0.s2,   ul1.s1, vl1.s1,   ul2.s1, vl2.s1,   ul3.s1, vl3.s1);
        uchar8 uvl3 = (uchar8)(ul0.s0, vl0.s0,   ul1.s0, vl1.s0,   ul2.s0, vl2.s0,   ul3.s0, vl3.s0);
...
bool YuvI420ToNV12Rotate::Init(bool rotate_to_left_90) {
    ...
    // select opencl code and kernel function name
    std::string cl_code;
    std::string kernel_function_name;
    if (rotate_to_left_90) {
        cl_code = yuvi420_to_nv12_rotate_l90_opencl_code();
        kernel_function_name = "kYuvI420ToNV12RotateLeft90";
    } else {
        cl_code = yuvi420_to_nv12_rotate_r90_opencl_code();
        kernel_function_name = "kYuvI420ToNV12RotateRight90";
    }
    ...
    m_kernel_yuvi420_to_nv12 = new cl::Kernel(*m_program, kernel_function_name.c_str(), &err);
